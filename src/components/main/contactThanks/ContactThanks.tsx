...
const Thankyoupage: React.FC = () => {
  return (
    ...
    >
      <Helmet>
        <title>Thank You for Contacting Us | Hetalbon</title>
        <meta
          name="description"
          content="We have received your message. Our team will get back to you soon."
        />
        <script>
          {`
    ...
    `}
      ...
      <div className="w-full md:w-1/2 animate-fadeIn text-center md:text-left mb-8 md:mb-0">
        <h1 className="text-4xl md:text-5xl font- font-bold mb-4 text-[#2b4a2b]">
          Thank You for Reaching Out!
        </h1>
        <p className="text-lg md:text-xl mb-8 leading-relaxed text-[#3e3e3e]">
          We’re thrilled to receive your message and will respond as soon as
          possible. At{" "}
          <span className="font-semibold">Hetalbon Eco Resort</span>, every
          guest is part of our community, and your interest inspires us to
          create even more memorable experiences.
        </p>
        <Link
          to="/"
      ...
      <div className="w-full md:w-1/2 flex justify-center animate-slideIn">
        <img
          src="https://res.cloudinary.com/drkhrpfro/image/upload/v1755078028/Hotel_Booking-cuate_pjfnjs.png"
          alt="Thank You Illustration"
          className="w-80 md:w-[400px] lg:w-[620px]"
        />
      </div>
