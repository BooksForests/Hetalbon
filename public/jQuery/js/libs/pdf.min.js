	...
	return (function (e) {
		...
		function (e, t, r) {
			...
			if (!a._pdfjsCompatibilityChecked) {
				...
				var o =
					...
					(typeof document === "undefined" ? "undefined" : n(document)) === "object";
				(function e() {
					if (a.btoa || !i()) {
						return;
					}
		...
		function (e, t, r) {
			...
			e.exports = function e() {
				return (
					(typeof process === "undefined" ? "undefined" : n(process)) === "object" &&
		...
		function (e, t, r) {
			...
			var i = function (e) {
				return function (t, r) {
					...
					u = i.charCodeAt(o);
					return u < 55296 || u > 56319 || o + 1 === s || (l = i.charCodeAt(o + 1)) < 56320 || l > 57343
						? e
							? i.charAt(o)
							: u
						: e
		...
		function (e, t, r) {
			...
			n(
				...
				{ create: le, defineProperty: se, defineProperties: ue, getOwnPropertyDescriptor: fe }
			);
			...
			function U(e) {
				...
				if (n.nativeImageDecoderSupport === undefined || !v.includes(n.nativeImageDecoderSupport)) {
					n.nativeImageDecoderSupport =
						s.apiCompatibilityParams.nativeImageDecoderSupport || a.NativeImageDecoding.DECODE;
				}
									...
									u()
										...
										["catch"](function (e) {
											t._readyCapability.reject(
												new Error('Setting up fake worker failed: "'.concat(e.message, '".'))
											);
										});
								}
							},
			...
			var m = (function e() {
				...
				m.prototype = {
					...
					showText: function e(t) {
						...
						var y =
							r.textRenderingMode === n.TextRenderingMode.FILL && !a.disableFontFace && !r.patternFill;
						o.save();
						var b;
						if (r.patternFill) {
							o.save();
				...
				_createStreamSink: function e(t) {
					...
					var d = {
						enqueue: function e(t) {
							...
							r.postMessage(
								{ sourceName: l, targetName: c, stream: i.ENQUEUE, streamId: s, chunk: t },
								o
							);
						},
						close: function e() {
